...
if($setting['block_hostname'] == "1") { // true untuk = 1 , false untuk = 0
...
if($setting['site_password'] == 1) {
    ...
    if(!isset($password)) {
        $click = fopen("bot/log_visitor.txt","a");
        $jam = date("h:i:sa");
...
// tambah coding untuk masuk parameter web anda
/* = example coding parameter =
==========================================
